...
Include discoveries that change scientific knowledge, significant advances with applications beyond one location, international space missions, cross-border public-health milestones, and substantial recovery of globally threatened species. The supplied source must establish that broader significance.
 Research and proposals can qualify under this policy: an experimental limit is a wording constraint, not itself a reason to exclude a story. New species, findings about evolution or the universe, and medical, energy or materials research can have worldwide relevance even when studied in one place. Do not require global deployment or an available product. Keep possible causes, associations, plans, prototypes, and mouse or lab results explicit; never present them as proven causes, finished projects or available cures.
